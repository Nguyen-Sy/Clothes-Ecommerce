    ...
    return (
        <div className="container-1139 layout discount">
            <div className="container-1139 discount-content-container">
                ...
                <p className="discount-desc">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed ullamcorper congue erosget tincidunt </p>
            ...
            <img src={require('../assets/img/hoodiee-1.jpg')} alt="discount-img" />
