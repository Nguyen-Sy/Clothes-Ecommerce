    ...
    return (
        <div className="container-1139 aboutus-container">
                <div className="aboutus-img-container">
                    <img src={require('../assets/img/aboutus-img.jpg')} alt="aboutus-img"/>
                </div>
                <div className="container-1139 aboutus-infor">
                    <p className="aboutus-heading">Best Fashion Since 2014</p>
                    <p className="aboutus-bdesc">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed ullamcorper congue eros, eget tincidunt ipsum eleifend ut orem ipsum dolor sit amet consectetur adipiscing elit Sed ullamcorper congue eros eleifend ut tincidunt ipsum .</p>
